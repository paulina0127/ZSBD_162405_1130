-- ----------------------------------------------------------------------
-- Wyzwalacze sprawdzające poprawność danych przy aktualizacji rekordu
-- ----------------------------------------------------------------------

DELIMITER //

-- Tabela Owners
CREATE TRIGGER validate_owner_update
...
-- Tabela Animals
CREATE TRIGGER validate_animal_update
...
-- Tabela Services
CREATE TRIGGER validate_service_update
...
-- Tabela Enclosures
CREATE TRIGGER validate_enclosure_update
...
-- Tabela Reservations
CREATE TRIGGER validate_reservation_update
